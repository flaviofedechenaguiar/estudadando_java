...
// usando a variavel de conexao do DAL
    ...
    public void logar() {
        ...
        try {
            ...
            //de dados funcao do que foi digitado nas caixas de 
            //texto. O ? e substituito pelo conteudo das variaveis
            pst = conexao.prepareStatement(sql);
            pst.setString(1, txtUsuario.getText());
            pst.setString(2, txtSenha.getText());

            // a linha abaixo executa a quary(consulta(select))
            rs = pst.executeQuery();

//se existir usuario e senha correspondente
            if (rs.next()) {
                // a linha abaicxo obtem o conteudo do campo perfil da tabela tbusuarios
                ...
                if (perfil.equals("admin")) {
                   ...
                   //a linha abaico fecha a tela de login
                    this.dispose();
                } else {
                    TelaPrincipal principal = new TelaPrincipal();
                    principal.setVisible(true);
                ...
                // a linha abaixo fecha a conexao com o banco de dados
                conexao.close();
            } else {
